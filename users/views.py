...
# ACTUALIZAR SIN IMAGENES
@api_view(['PUT'])
@permission_classes([IsAuthenticated])
def update(request, id_user):
    # Asegurarse de que el usuario autenticado es el mismo que el que se intenta actualizar
    ...
    logger.warning("+++++++++++++++++++++++++++++++++++++++++++++")
    logger.warning(f"Usuario actualizado correctamente:  - {user_data}")
...
def updateWithImage(request, id_user):
    ...
    logger.warning("+++fotoooooooooooooooooooooooooooooooooooooooo++++++")
    logger.warning(f"photooooooo  - {image}")
    ...
    if image:
        ...
        # Guardar URL en el modelo (solo si hay imagen)
